...
//     <>
//     {
// checkOutArray?.map((checkoutData)=>{
//     return (
//         <>
...
//             <Text>Room :</Text>
//             <Text>{checkoutData.roomNo} | {checkoutData.roomType} | {checkoutData.floor} </Text>
//             </View>

//             <View style={{flexDirection:'row',gap:5}}>
//             <Text>Guest :</Text>
//              {
//                 checkoutData?.guests?.map(name=>{
//                     return (
//                         <>
//                         <Text>{name},</Text>
//                         </>
...
//             <View style={{flexDirection:'row',gap:5}}>
//             <Text>Checkout : </Text>
//             <Text>{checkoutData.checkOutDate} , {checkoutData.checkOutTime} </Text>
//             </View>
//             <View style={{flexDirection:'row',gap:5}}>
//             <Text>Phone Number</Text>
//             <Text>{checkoutData.phoneNumber} </Text>
//             </View>
//          </View>
